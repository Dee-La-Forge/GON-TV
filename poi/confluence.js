(function () {
  ...
  function build() {
    ...
    css.textContent = `
      ...
      #gonRightRow > #gonLiqPanel { flex:0 0 221px; }
      /* les deux tours (221+8+221) font exactement la largeur de l'ecran */
      #gonRightCol > #gonLiqVideo { margin:0 8px 8px 0; align-self:flex-start; width:450px;
